...
<body style="background:#f0f9fd;">
    ...
    <dd id="studentIqCard">
    <div class="title">
    <span><img src="images/leftico01.png" /></span>校园IC卡管理
    </div>
    	<ul class="menuson">
    	 <li><cite></cite><a href="cardform.jsp" target="rightFrame">添加卡片</a><i></i></li>
        <li><cite></cite><a href="CardList.jsp" target="rightFrame">卡信息管理</a><i></i></li>
